            ...
            <footer className="border rounded-5xl mx-auto bg-glass footer footer-center p-10">
                ...
                <nav>
                    <div className="grid grid-flow-col gap-4">
                        {/* Twitter */}
                        <a className="text-red-500 hover:scale-110 transition">
                        ...
                        {/* YouTube */}
                        <a className="text-sky-400 hover:scale-110 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="fill-current">
                        ...
                        {/* Facebook */}
                        <a className="text-blue-500 hover:scale-110 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="fill-current">
